...
var rootURL = "http://localhost/PhpstormProjects/aealandiaApi/api/";
...
function findAllListView() {
    console.log('findAllListView');
    $.ajax({
        type: 'GET',
        url: rootURL,
        dataType: "json", // data type of response
        success: renderDetailsListView
    });
}
...
function renderDetailsListView(list){

    $('#listId').val(list.id);
    $('#list_Cat').val(list.name);
    $('#list_name').val(list.grapes);
    $('#list_img').attr('src',  'images/'+ catagories)
    $('#list_sound').attr('src',  'sound/'+ catagories)
    $('#list_description').val(list.year);

}
function formToJSON() {
    return JSON.stringify({
        "id": $('#listId').val(),
        "catagories": $('#list_Cat').val(),
        "name": $('#list_name').val(),
        "list_img": $('#list_img').val(),
        "list_sound": $('#list_sound').val(),
        "list_desc": $('#list_description').val(),
