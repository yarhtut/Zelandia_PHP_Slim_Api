<div class="container-fluid sanctuary_container">
    <div class="container ">
        ...
        <div class="page-header">
            <h1>Sanctuary <small>Zealandia all birds, insects, plants, mammals and others</small></h1>
        </div>
        ...
        <div class="page-header-menu">
            <div class="bs-example">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li><a data-toggle="tab" href="#section_mammals"  id="section_mammals">MAMMALS</a></li>
                    <li><a data-toggle="tab" href="#section_others"  id="section_others">OTHERS</a></li>
                </ul>
            ...
            <script>
                ...
                $("document").ready(function(){
                    ...
                    $("#section_mammals").click(function(){
                        showCat("mammals");
                        console.log('mammals clicked');
                    })
                    $("#section_others ").click(function(){
                        showCat("others");
                        console.log('other clicked');
                    })
